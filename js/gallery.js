...
const simpleGallery = function(domElement){
    var element = domElement;
    var slidesList = new SlidesList();
    var pagerList = [];
    var activePagerIndex = -1;

    const buttonPrev = element.getElementsByClassName("prev")[0].getElementsByTagName("button")[0];
    const buttonNext = element.getElementsByClassName("next")[0].getElementsByTagName("button")[0];
...
var galleries = document.getElementsByClassName('simple-gallery');
